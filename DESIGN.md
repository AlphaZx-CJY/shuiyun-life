...
| **超大圆角** | `24rpx ~ 28rpx` | 大卡片、Banner、底部浮层 | 表达内容容器、包容性强、友好 |
| **大圆角** | `16rpx ~ 20rpx` | 标准卡片、对话框、媒体容器 | 标准内容层级 |
| **中圆角** | `12rpx ~ 14rpx` | 输入框、小型面板、列表项 | 功能性组件，偏工具属性 |
...
| 卡片（Card） | `20rpx` | `--md-surface` / `--md-surface-container` | 内容容器 |
