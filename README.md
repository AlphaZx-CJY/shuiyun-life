...
## 项目简介
为「新长宁水韵名邸」小区打造的微信小程序生活号，面向小区居民提供周边生活信息、闲置交易、新闻资讯、缴费知识、便民安排、班车信息、意见反馈和使用指南等功能。全部内容支持通过 **微信云开发数据库 CMS** 动态更新，无需修改代码即可维护小程序内容。
...
## 功能模块
1. **首页** — Banner 轮播（首屏班车卡片 + 图片轮播）、快捷入口（6 个 Emoji 图标）、社区通知、今日便民
2. **新闻资讯** — 文章列表、分类筛选（通知/政策/周边）、详情页
3. **闲置交易** — 商品列表、分类筛选、详情页、用户发布（本地缓存 + 云端）
4. **周边生活** — 超市、菜场、美食、酒店、交通、学校、休闲、医疗、商场共 9 个分类
5. **缴费知识** — 物业费、水费、电费、燃气费指南
6. **便民安排** — 社区活动日历，当天活动自动展示在首页
